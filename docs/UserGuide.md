...
1. **When using multiple screens**, if the previously saved window position is no longer available, CMS opens using a default visible placement instead of restoring the off-screen position.
